...
export default {
  ...
  segmentActiveBackgroundColor: "transparent",
  segmentTextColor: "#a3daf7",
  segmentActiveTextColor: "#fff",
  segmentBorderColor: "#2daaed",
  ...
  // Tab
  tabDefaultBg: "#fff",
  topTabBarTextColor: "#252525",
  topTabBarActiveTextColor: "#70c7f3",
  topTabActiveBgColor: undefined,
  topTabBarBorderColor: "#fff",
  topTabBarActiveBorderColor: "#1ca3ec",

  // Header
  toolbarBtnColor: "#fff",
  toolbarDefaultBg: "#2daaed",
